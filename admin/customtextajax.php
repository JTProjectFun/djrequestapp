        ...
        <table class="table bordered table-striped table-condensed settings_table">
            ...
            foreach($record as $records) {
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("success|".$records['id']); ?>" value="<?php echo $records['success']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("banned|".$records['id']); ?>" value="<?php echo $records['banned']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("toomany|".$records['id']); ?>" value="<?php echo $records['toomany']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("sqlerror|".$records['id']); ?>" value="<?php echo $records['sqlerror']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("tooshort|".$records['id']); ?>" value="<?php echo $records['tooshort']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("toomanyuser|".$records['id']); ?>" value="<?php echo $records['toomanyuser']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("floodalert|".$records['id']); ?>" value="<?php echo $records['floodalert']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("fieldblank|".$records['id']); ?>" value="<?php echo $records['fieldblank']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("fieldtoolong|".$records['id']); ?>" value="<?php echo $records['fieldtoolong']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <input type="text" class="form-control customtextinput" name="<?php echo encrypt("norequests|".$records['id']); ?>" value="<?php echo $records['norequests']; ?>" /></div></td>
                ...
                <tr>
                    ...
                    <textarea class="form-control customtextinput" rows="4" name="<?php echo encrypt('forgotpassemail|'.$records['id']); ?>">
<?php echo $records['forgotpassemail']; ?>" </textarea>
</div></td>
